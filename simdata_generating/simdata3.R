...
simdata3 <- function(p,s,n.tar,n.src,n.test,del,c){
  ...
  y.tar= c*m.src(X.tar) + delta(X.tar, del, s) + rnorm(n.tar, 0, 1)
  y.test= c*m.src(X.test) + delta(X.test, del, s) + rnorm(n.test, 0, 1)
